...
echo"<html> 
       ...
       <a  href='Sindicato_Taxis.php'>Listado de Personas</a>
...
$rs = $db->GetAll($sql);*/
 /*  if ($rs) {*/
        echo"<form action='sindicato_nuevo1.php' method='post' name='formu'>";
        echo"<center>
                <table class='listado'>
                <tr>
                <th><b>NOMBRE</b></th>
                <td><input type='text' name='nombre' size='10' ></td>
                  ...
                  <tr>
                    <td align='center' colspan='2'>  
                      <input type='submit' value='ADICIONAR SINDICATO'  >
                    </td>
                  </tr>
                </table>
                </center>";
