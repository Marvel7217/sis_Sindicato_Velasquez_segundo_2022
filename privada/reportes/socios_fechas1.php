...
$sql = $db->Prepare("SELECT CONCAT_WS(' ', nombres, ap, am) as socio, fec_nac
                FROM socios
...
if ($rs) {
        ...
        <td align='center' width='80%'><h1>REPORTES DE SOCIOS CON FECHAS DE NACIMIENTO</h1></td>
        </tr>
        </table>";
echo"
        <center>
        ...
        <tr>
        <th>Nro</th><th>SOCIOS</th><th>FECHA DE NACIMIENTO</th>
        </tr>";
        $b=1;
