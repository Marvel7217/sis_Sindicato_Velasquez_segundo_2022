    ...
    if($rs){
        echo"<table border='0' width='100%' >
             <tr>
                ...
                <td align='center' width='80%'><h1>REPORTE DE CHOFERES-MOVILES CON FECHAS</h1></td>
            </tr>
        </table>";
    echo"
    <center>
     <table border ='1' cellspacing='0'>
      <tr>
      <th>Nro</th><th>SOCIOS</th><th>MODELOS DE MOVIL</th><th>FECHA INICIO</th><th>FECHA FIN</th>
    </tr>";
    $b=1;
