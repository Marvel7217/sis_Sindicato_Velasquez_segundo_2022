                    ...
                    <td align='center'>
                        ...
                        <td align='center'>
                            <form name='formElimi".$fila["id_persona_1"]."' method='post' action='persona_eliminar.php'>
                                <input type='hidden' name='id_persona_1' value='".$fila["id_persona_1"]."'>
                                <a href='javascript:document.formElimi".$fila['id_persona_1'].".submit();' title='Eliminar Persona Sistema' onclick='javascript:return(confirm( Desea realmente Eliminar a la persona..?))'; location.href='persona_eliminar.php''>
                                Eliminar>>
                                </a>
                              </form>                        
                            </td>
