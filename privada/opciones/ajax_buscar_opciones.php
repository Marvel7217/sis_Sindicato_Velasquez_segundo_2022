        ...
        foreach ($rs3 as $k => $fila) {                                       
            ...
            <td>".resaltar($grupo, $str)."</td>
                    ...
                    <td align='center'>
                        ...
                        <td align='center'>
                            <form name='formElimi".$fila["id_opcion"]."' method='post' action='persona_eliminar.php'>
                                <input type='hidden' name='id_opcion' value='".$fila["id_opcion"]."'>
                                <a href='javascript:document.formElimi".$fila['id_opcion'].".submit();' title='Eliminar Opcion Sistema' onclick='javascript:return(confirm( Desea realmente Eliminar a la persona..?))'; location.href='persona_eliminar.php''>
                                Eliminar>>
                                </a>
                              </form>                        
                            </td>
